...
func (x *Measurement) GetWeight() float32 {
	if x != nil {
		return x.Weight
	}
	return 0
...
func (x *Measurement) GetColor() float32 {
	if x != nil {
		return x.Color
	}
	return 0
...
var file_measurement_proto_rawDesc = []byte{
	...
	,
...
var file_measurement_proto_goTypes = []interface{}{
	...
	(*OK)(nil),          // 1: measurement.OK
}
var file_measurement_proto_depIdxs = []int32{
	0, // 0: measurement.MeasurementService.NewMeasurement:input_type -> measurement.Measurement
	1, // 1: measurement.MeasurementService.NewMeasurement:output_type -> measurement.OK
...
func (c *measurementServiceClient) NewMeasurement(ctx context.Context, in *Measurement, opts ...grpc.CallOption) (*OK, error) {
	out := new(OK)
	err := c.cc.Invoke(ctx, "/measurement.MeasurementService/NewMeasurement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMeasurementServiceServer) NewMeasurement(context.Context, *Measurement) (*OK, error) {
...
func _MeasurementService_NewMeasurement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/measurement.MeasurementService/NewMeasurement",
	}
